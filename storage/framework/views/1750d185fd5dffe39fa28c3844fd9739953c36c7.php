...
<?php $component->withAttributes(['href' => ''.e(route('dashboard')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard')),'style' => 'color: white']); ?>
                        <img class="mr-5" style="width: 9%; height: auto" src="<?php echo e(asset('img/Weblogo.png')); ?>"
...
</nav><?php /**PATH C:\Laravel_project\finalProject\resources\views/navigation-menu.blade.php ENDPATH**/ ?>